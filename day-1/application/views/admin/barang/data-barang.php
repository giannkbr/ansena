        ...
        <div class="card">
            <div class="card-body">
                <div class="row mb-2">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <button type="button" class="btn btn-success btn-responsive" data-toggle="tooltip" data-placement="top" title="Tambah barang" onclick="add_barang()"><i class="uil-plus-circle"></i> Add barang</button>
                            <button class="btn btn-info btn-responsive" data-toggle="tooltip" data-placement="top" title="Reload" onclick="reload_table()"><i class="uil-sync"></i> Reload</button>
                            <button id="deleteList" class="btn btn-danger btn-responsive" data-toggle="tooltip" data-placement="right" title="Delete List" style="display: none;" onclick="deleteList()"><i class="uil-trash-alt"></i> Delete List</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" id="btnSave" onclick="save()" class="btn btn-primary btn-responsive" redirect(site_url().'admin/dataBarang');>Simpan</button>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.foto_barang) {
                    ...
                    $('#photo-preview div').html('<img width="100px" height="150px" src="' + base_url + '/assets/images/uploads/barang/' + data.foto_barang + '" class="img-thumbnail">'); // show photo
                    $('#photo-preview div').append(' <input type="checkbox" name="remove_photo" value="' + data.foto_barang + '"/> Remove photo when saving'); // remove photo
